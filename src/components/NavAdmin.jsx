    ...
    return (
        <div className="w-full">
            <nav className="text-white p-2 flex justify-between items-center">
                <div className='w-4/5 items-center justify-around flex mr-2'>
                    ...
                    <Link to='/admin' className={`${location.pathname === '/admin' ? 'text-white' : 'text-blue-400'} font-semibold transition-all mx-2  flex`}>
